  ...
  return (
    <div className="site-container py-6 page-enter">
      ...
      <div className="flex items-center gap-2 text-sm text-[var(--text-muted)] mb-6">
        ...
        <span>/</span>
        <span className="text-[var(--text-primary)] truncate max-wxs">
          {product.name}
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-14 mb-16">
        ...
        <div className="flex flex-col">
          <div className="mb-6">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 leading-[1.2]">
              {product.name}
            </h1>
          ...
          <div className="bg-[var(--bg-tertiary)] rounded-2xl p-4 sm:p-6 mb-6">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="flex-1 h-12 text-sm font-bold text-white bg-linear-to-r from-[#ef4a23] to-[#d63516] rounded-lg hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    toast.error("Login required or already in wishlist");
                  }
                }}
          ...
          <AnimatePresence mode="wait">
            {activeTab === "description" && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="prose prose-sm md:prose-base max-w-none text-[var(--text-secondary)]"
              >
                <div
                ...
                <table className="spec-table border border-[var(--border)] rounded-xl overflow-hidden">
                  <tbody>
                    {Object.entries(product.attributes!).map(([k, v], i) => (
                      ...
                      >
                        <td className="w-1/3 py-3 px-4 font-semibold text-[var(--text-secondary)] border-r border-[var(--border)]">
                          {k}
                        </td>
